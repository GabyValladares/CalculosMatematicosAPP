...
public class Exponenciales extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnCalcular = findViewById(R.id.btnCalcular2);
        Button btnRegresar = findViewById(R.id.btnRegresar2);
        ...
        btnRegresar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent in=new Intent(Exponenciales.this,MenuOperaciones.class);
                startActivity(in);// Regresar a la actividad anterior
            }
        });
    }
}
